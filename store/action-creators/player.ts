...
export const enterFullScreen = (): PlayerAction => {
    return { type: PlayerActionTypes.ENTER_FULLSCREEN };
};
export const exitFullScreen = (): PlayerAction => {
    return { type: PlayerActionTypes.EXIT_FULLSCREEN };
};
